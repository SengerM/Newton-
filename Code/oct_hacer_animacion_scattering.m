...
graf = plot3(data(2,columnas_x), data(2,columnas_y), data(2,columnas_z));
set(graf, 
	'LineWidth', 2,
	'LineStyle', 'none',
	'Marker', '.',
...
for (kk = kk_inicial:length(t))
	...
	set(graf, "xdata", data(kk,columnas_x), "ydata", data(kk,columnas_y), "zdata", data(kk,columnas_z));
